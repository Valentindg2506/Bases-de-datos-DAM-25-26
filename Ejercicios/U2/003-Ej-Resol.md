En este ejercicio vamos a crear una base de datos para almacenar datos de jugadores de rugby.

---

Para realizar este ejercicio tenemos que seguir estos pasos:
...
**NOTAS:**
- Hay que recordar poner `;` al final de cada codigo dentro de MySql ya que de no hacerlo no lo va a ejecutar.
