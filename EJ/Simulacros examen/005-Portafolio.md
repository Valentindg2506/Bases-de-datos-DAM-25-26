En este ejercicio vamos a crear una base de datos funcional para un portafolio, almacenando pieza y categoria.
...
```
Le agregamos el identificador con la clave primaria:
```
	ALTER TABLE pieza
...
```
Le agregamos un identificador tambien:
```
